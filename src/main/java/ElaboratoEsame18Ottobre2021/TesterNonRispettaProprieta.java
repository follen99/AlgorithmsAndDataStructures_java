...
/* Questo esempio riporta un albero che NON rispetta la proprietà di bilanciamento,
 * in quanto la foglia più vicina è (4), posta a 2 nodi dalla root.
 * la foglia più lontana è (12) o (11), poste a 5 nodi dalla root.
 *
 * siccome 5 < 2 * 2 NON rispetta le proprietà.
 * */
public class TesterNonRispettaProprieta {
    public static void main(String[] args) {
        ...
        tree.root.right.left.left.right.left = new VerificaAlbero.Node(11);
        tree.root.right.left.left.right.right = new VerificaAlbero.Node(12);
